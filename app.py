...
# Test endpoint - supports GET, POST, PUT, PATCH
@app.get("/api/test", tags=["Test"])
@app.post("/api/test", tags=["Test"])
@app.put("/api/test", tags=["Test"])
@app.patch("/api/test", tags=["Test"])
async def test_endpoint(request: Request):
    """Test endpoint that responds with 200 for GET, POST, PUT, PATCH requests"""
    return {
        "status": "success",
